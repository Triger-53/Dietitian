...
CREATE UNIQUE INDEX IF NOT EXISTS unique_online_appointment_slot on public."Appointment" using btree (
  "preferredDate",
  "preferredTime",
  "consultationMethod"
) TABLESPACE pg_default
...
CREATE UNIQUE INDEX IF NOT EXISTS unique_offline_appointment_slot on public."Appointment" using btree (
  "preferredDate",
  "preferredTime",
  "consultationMethod",
  "medicalCenter"
