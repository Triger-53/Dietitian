...
const Services = () => {
			...
			; (async () => {
				try {
					...
					const mappedServices = list.map((service) => ({
						...service,
						icon: React.createElement(iconMap[service.icon] || Apple, {
							className: "w-8 h-8",
						}),
					}))
	...
	if (loading) {
		return (
			<>
				<SEO
					title="Services - Dr. Mama"
					description="Explore the comprehensive nutrition and diet services offered by Dr. Mama. We provide personalized plans for children, teens, adults, and seniors."
				/>
					...
					<div className="max-w-7xl mx-auto text-center">
						<motion.div
							...
							<p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
								Comprehensive nutrition and diet services designed to meet your
								health needs at every age. From weight management to sports nutrition, we're
								here to support your wellness journey.
							</p>
							...
							<motion.div
								...
								<div className="space-y-4">
									<div className="flex items-center">
										...
										<span className="text-gray-700">
											Certified and registered dietitian
										</span>
									</div>
									<div className="flex items-center">
										<Star className="w-5 h-5 text-yellow-400 fill-current mr-3" />
									...
									<div className="flex items-center">
										<Star className="w-5 h-5 text-yellow-400 fill-current mr-3" />
										<span className="text-gray-700">
											Nutritional guidance for all age groups
										</span>
									</div>
									<div className="flex items-center">
										<Star className="w-5 h-5 text-yellow-400 fill-current mr-3" />
				...
				<section className="section-padding bg-primary-600 relative overflow-hidden">
					...
					<div className="max-w-4xl mx-auto text-center relative z-10">
						...
						<p className="text-xl text-primary-100 mb-8">
							Book your appointment online or call us to discuss your diet
							and nutrition needs.
						</p>
						<div className="flex flex-col sm:flex-row gap-4 justify-center">
							<Link
