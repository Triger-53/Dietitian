...
const Home = () => {
	...
	return (
		<>
			<SEO
				title="Dr. Mama - Registered Dietitian Nutritionist"
				description="Compassionate and professional nutrition counseling services for all ages. Dr. Mama is a certified Dietitian with over 25 years of experience."
			/>
						...
						<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
							<motion.div
								...
								<p className="text-xl md:text-2xl text-gray-600 mb-10 leading-relaxed">
									Experience exceptional <span className="font-semibold text-primary-700">diet & nutrition counseling</span> with Dr. Mama.
					...
					<div className="max-w-7xl mx-auto relative z-10">
						<div className="text-center mb-16">
							...
							<p className="text-xl text-gray-600 max-w-3xl mx-auto">
								Comprehensive nutrition services designed to meet your
								health needs at every age.
							</p>
						</div>
				...
				<section className="section-padding bg-primary-600 relative overflow-hidden">
					...
					<div className="max-w-4xl mx-auto text-center relative z-10">
						...
						<p className="text-xl text-primary-100 mb-8">
							Book your appointment today and start your journey to better diet
							and wellness.
						</p>
