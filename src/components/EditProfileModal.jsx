      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-3xl w-full m-4 transform transition-all duration-300 scale-95 hover:scale-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 max-h-[70vh] overflow-y-auto pr-4">
          ...
          <div className="flex justify-end gap-4 pt-6 border-t mt-8">
            <button type="button" onClick={onClose} disabled={isSaving} className="px-6 py-2.5 bg-gray-200 text-gray-800 rounded-full font-semibold hover:bg-gray-300 transition-colors disabled:opacity-50">Cancel</button>
            <button type="submit" disabled={isSaving} className="px-6 py-2.5 bg-primary-600 text-white rounded-full font-semibold hover:bg-primary-700 transition-colors shadow-md flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed">
